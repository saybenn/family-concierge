...
export const packages = [
  {
    ...
    personas: ["Busy Professionals", "Parents"],
  ...
  },
  {
    ...
    icon: "/icons/weekend-reset.svg",
    demographics: ["parents", "professional"],
    personas: ["Parents", "Busy Professionals"],
    personaHint: "Family-ready reset without spending Saturday cleaning.",
    href: "/packages/weekend-home-reset",
  },
  {
    slug: "errand-blitz",
    name: "Errand Blitz",
  ...
  },
  {
    ...
    demographics: ["professional", "parents"],
    personas: ["Busy Professionals", "Parents"],
    personaHint: "Entertain well, without the prep and cleanup drag.",
    href: "/packages/party-prep-tidy",
  },
  {
    slug: "travel-helper",
    name: "Travel Helper",
  ...
  },
  {
    ...
    demographics: ["parents", "professional", "caregivers"],
    personas: ["Parents", "Busy Professionals", "Caregivers"],
    personaHint: "Festive home without the ladder risk or hassle.",
    href: "/packages/holiday-decor",
  },
  {
    ...
    icon: "/icons/move-in.svg",
    demographics: ["professional", "parents"],
    personas: ["Busy Professionals", "Parents"],
    personaHint: "Land smoothly — live-in rooms ready on day one.",
    href: "/packages/move-in-refresh",
  },
  {
    slug: "gift-concierge",
    name: "Gift Concierge",
    ...
    demographics: ["professional", "parents"],
    personas: ["Busy Professionals", "Parents"],
    personaHint: "Thoughtful gifts handled end-to-end, on time.",
    href: "/packages/gift-concierge",
  },
];
